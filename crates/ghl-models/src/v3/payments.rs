//! `payments` data models for GoHighLevel API V3 (55 types).
//!
//! Generated from HighLevel's official OpenAPI spec for the
//! **Payments** module. Every endpoint that uses these types, with its
...
pub struct CouponDto {
    ...
    /// Variant Ids
    #[serde(rename = "variantIds", default, skip_serializing_if = "Vec::is_empty")]
