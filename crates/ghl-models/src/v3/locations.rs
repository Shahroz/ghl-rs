//! `locations` data models for GoHighLevel API V3 (53 types).
//!
//! Generated from HighLevel's official OpenAPI spec for the
//! **Locations** module. Every endpoint that uses these types, with its
...
/// `ConversationChannelEntrySchema` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct ConversationChannelSchema {
    /// List of SMS providers configured for this location
    #[serde(rename = "SMS", default, skip_serializing_if = "Vec::is_empty")]
    pub sms: Vec<ConversationChannelEntrySchema>,
    /// List of Email providers configured for this location
    #[serde(rename = "Email", default, skip_serializing_if = "Vec::is_empty")]
    pub email: Vec<ConversationChannelEntrySchema>,
}

/// `ConversationProviderSchema` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `GetConversationChannelListSuccessfulResponseDto` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `PermissionsResponseDto` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct PermissionsResponseDto {
    /// Enabled permission names for the sub-account
    /// Allowed values: `2-way-text-messaging`, `gmb-messaging`, `web-chat`,
    /// `reputation-management`, `facebook-messenger`, `gmb-call-tracking`,
...
/// `UpdatePermissionsDto` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
