//! `calendars` data models for GoHighLevel API V3 (94 types).
//!
...
pub struct CalendarCreateDTO {
    ...
    /// Allowed values: `hours`, `days`, `weeks`, `months`, `mins`.
    #[serde(
    ...
    /// While we will support this property for backward compatibility, it is recommended to use
    /// 'Availability' APIs instead.
    ...
    /// While we will support this property for backward compatibility, it is not required
    /// anymore.
    /// Allowed values: `0`, `1`.
    #[serde(
...
pub struct CreateBookingServiceDTO {
    ...
    pub id: String,
    /// Staff ID
    #[serde(rename = "staffId", default, skip_serializing_if = "Option::is_none")]
...
/// `CreateEventCalendarScheduleDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct CreateEventCalendarScheduleDTO {
...
pub struct CreateOrUpdateServiceBookingResponseDTO {
    ...
    pub meeting_location: Option<String>,
    /// Optional informative or warning messages (e.g. meeting location ignored for
    /// non-ask-booker locations)
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub messages: Vec<Vec<serde_json::Value>>,
}

/// `CreatePublicServiceBookingDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct CreatePublicServiceBookingDTO {
    /// Location ID
    /// Required by the API.
    #[serde(rename = "locationId")]
    pub location_id: String,
    ...
    /// Required by the API.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub services: Vec<CreateBookingServiceDTO>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub title: Option<String>,
    /// Status. (If not provided, the status configured in Service Global Settings will be
    /// used.)
...
pub struct CreateServiceDTO {
    ...
    /// Payment details (default amount is 0, currency configured in Service Global Settings is
    /// used.)
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub pre_buffer_unit: Option<String>,
    /// Post-buffer: Additional time that can be added after an appointment, allowing for extra
    /// time to wrap up
    #[serde(
        rename = "postBuffer",
        default,
    ...
    /// Custom form ID (will be used to display the custom form on the booking page, if only one
    /// service is selected)
    #[serde(rename = "formId", default, skip_serializing_if = "Option::is_none")]
    pub form_id: Option<String>,
...
pub struct CreateServiceLocationDTO {
    ...
    /// Use a full street address when locationType is offline. Use a user-facing label when
    /// locationType is ask_booker.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
...
/// `DeleteServiceBookingResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `DeleteServiceResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `EventCalendarScheduleResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `EventCalendarScheduleWrapperDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `PaymentDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `ServiceAddOnResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
pub struct ServiceBookingQueryDTO {
    /// If true the time slot validation would be avoided for any booking creation/update (even
    /// the skipSchedulingNotice)
    #[serde(
        rename = "overrideAvailability",
        default,
        skip_serializing_if = "Option::is_none"
    )]
...
/// `ServiceBookingResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `ServiceBookingsListResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `ServiceLocationListResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct ServiceLocationListResponseDTO {
    ...
    pub service_locations: Vec<ServiceLocationResponseDTO>,
}

/// `ServiceLocationResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `ServiceResponseWrapperDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `ServicesListResponseDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
...
/// `StaffDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct StaffDTO {
    /// Staff ID
    /// Required by the API.
...
/// `UpdateEventCalendarScheduleDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct UpdateEventCalendarScheduleDTO {
...
/// `UpdateServiceBookingDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct UpdateServiceBookingDTO {
    /// Service Location ID
    #[serde(
        rename = "serviceLocationId",
        default,
    ...
    pub title: Option<String>,
    /// Status
    /// Allowed values: `confirmed`, `cancelled`, `invalid`, `new`, `showed`, `no_show`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    /// Start Time
    #[serde(rename = "startTime", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub timezone: Option<String>,
    /// If provided, services sent in the request will replace the existing services in the
    /// booking.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub services: Vec<CreateBookingServiceDTO>,
}

/// `UpdateServiceDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct UpdateServiceDTO {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub staff: Vec<StaffDTO>,
    /// Service variations (an empty array removes all variations). Include an id to update an
    /// existing variation; omit the id to create a new one.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub variations: Vec<UpdateServiceVariationDTO>,
}

/// `UpdateServiceLocationDTO` from the GoHighLevel OpenAPI spec.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct UpdateServiceLocationDTO {
    /// Location name
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
