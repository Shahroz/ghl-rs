...
//! `invoices` — typed methods for all 42 API v2 operations
//! in this module.
//!
//! Access via [`Ghl::invoices`](crate::Ghl::invoices).
//!
//! Request and response types come from [`ghl_models::v2::invoices`](https://docs.rs/ghl-models/latest/ghl_models/v2/invoices/); every endpoint is also documented in the
...
/// Typed access to the `invoices` API v2 surface (42 operations). Obtained via
/// [`Ghl::invoices`](crate::Ghl::invoices).
#[derive(Debug, Clone)]
