...
//! `objects` — typed methods for all 9 API v3 operations
//! in this module.
//!
//! Access via [`Ghl::v3`](crate::Ghl::v3)`().objects()`. These endpoints send `Version: v3`.
//!
//! Request and response types come from [`ghl_models::v3::objects`](https://docs.rs/ghl-models/latest/ghl_models/v3/objects/); every endpoint is also documented in the
...
use ghl_models::v3::objects as models;

/// Typed access to the `objects` API v3 surface (9 operations). Obtained via
/// [`Ghl::v3`](crate::Ghl::v3)`().objects()`.
#[derive(Debug, Clone)]
