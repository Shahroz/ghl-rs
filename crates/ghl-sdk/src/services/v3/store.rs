...
//! `store` — typed methods for all 18 API v3 operations
//! in this module.
//!
//! Access via [`Ghl::v3`](crate::Ghl::v3)`().store()`. These endpoints send `Version: v3`.
//!
//! Request and response types come from [`ghl_models::v3::store`](https://docs.rs/ghl-models/latest/ghl_models/v3/store/); every endpoint is also documented in the
...
use ghl_models::v3::store as models;

/// Typed access to the `store` API v3 surface (18 operations). Obtained via
/// [`Ghl::v3`](crate::Ghl::v3)`().store()`.
#[derive(Debug, Clone)]
