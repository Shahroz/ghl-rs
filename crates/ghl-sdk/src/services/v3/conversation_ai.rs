...
//! `conversation-ai` — typed methods for all 12 API v3 operations
//! in this module.
//!
//! Access via [`Ghl::v3`](crate::Ghl::v3)`().conversation_ai()`. These endpoints send `Version: v3`.
//!
//! Request and response types come from [`ghl_models::v3::conversation_ai`](https://docs.rs/ghl-models/latest/ghl_models/v3/conversation_ai/); every endpoint is also documented in the
...
use ghl_models::v3::conversation_ai as models;

/// Typed access to the `conversation-ai` API v3 surface (12 operations). Obtained via
/// [`Ghl::v3`](crate::Ghl::v3)`().conversation_ai()`.
#[derive(Debug, Clone)]
